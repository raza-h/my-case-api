...
namespace MyCaseApi.Migrations
{
    ...
    [Migration("20230704103727_tablesupdated")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyCaseApi.Entities.CFieldValue", b =>
                {
            ...
            modelBuilder.Entity("MyCaseApi.Entities.ClientLocation", b =>
                {
            ...
            modelBuilder.Entity("MyCaseApi.Entities.CustomField", b =>
                {
                    b.Property<int>("FieldId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("FullPractice")
                        .HasColumnType("bit");

                    b.Property<bool>("PartialPractice")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("MyCaseApi.Entities.CustomPractice", b =>
                {
                    b.Property<int>("PracticeFieldID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("PracticeFieldID");

                    b.ToTable("CustomPractice");
                });
            ...
            modelBuilder.Entity("MyCaseApi.Entities.DocSub1Folder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("DocSub1Folder");
                });

            modelBuilder.Entity("MyCaseApi.Entities.DocSub2Folder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("DocSub1FolderId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DocSub1FolderId");

                    b.ToTable("DocSub2Folder");
                });

            modelBuilder.Entity("MyCaseApi.Entities.DocSub3Folder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("DocSub2FolderId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DocSub2FolderId");

                    b.ToTable("DocSub3Folder");
                });

            modelBuilder.Entity("MyCaseApi.Entities.DocumentCategory", b =>
                {
                    ...
                    b.Property<int?>("DocSub3FolderId")
                        .HasColumnType("int");

                    b.Property<int?>("DocuementFolderId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DocSub3FolderId");

                    b.HasIndex("DocuementFolderId");

                    b.ToTable("DocumentCategory");
                });

            modelBuilder.Entity("MyCaseApi.Entities.DocumentFolder", b =>
                {
            ...
            modelBuilder.Entity("MyCaseApi.Entities.DocumentSign", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("DocumentSavedPath")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DocumentStatus")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DocumentString")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime>("SignCompletedDate")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("SignRequestedDate")
                        .HasColumnType("datetime2");

                    b.HasKey("Id");

                    b.ToTable("DocumentSign");
                });
            ...
            modelBuilder.Entity("MyCaseApi.Entities.HireReason", b =>
                {
            ...
            modelBuilder.Entity("MyCaseApi.Entities.LeadStatus", b =>
                {
                    b.Property<int>("LStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyCaseApi.Entities.TestUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyCaseApi.Entities.TimeEntry", b =>
                {
            ...
            modelBuilder.Entity("MyCaseApi.Entities.TimeEntryActivity", b =>
                {
                    b.Property<int>("ActivityId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyCaseApi.Entities.TimeLine", b =>
                {
                    ...
                    b.Property<byte[]>("DocFilePathbyte")
            ...
            modelBuilder.Entity("MyCaseApi.Entities.WorkflowBase", b =>
                {
                    b.Property<int>("WorkflowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyCaseApi.Entities.DocSub1Folder", b =>
                {
                    b.HasOne("MyCaseApi.Entities.DocumentFolder", "DocumentFolder")
                        .WithMany("DocSub1Folders")
            ...
            modelBuilder.Entity("MyCaseApi.Entities.DocSub2Folder", b =>
                {
                    b.HasOne("MyCaseApi.Entities.DocSub1Folder", "DocSub1Folder")
                        .WithMany()
                        .HasForeignKey("DocSub1FolderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DocSub1Folder");
                });

            modelBuilder.Entity("MyCaseApi.Entities.DocSub3Folder", b =>
                {
                    b.HasOne("MyCaseApi.Entities.DocSub2Folder", "DocSub2Folder")
                        .WithMany("DocSub3Folders")
                        .HasForeignKey("DocSub2FolderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DocSub2Folder");
                });
            ...
            modelBuilder.Entity("MyCaseApi.Entities.DocumentCategory", b =>
                {
                    ...
                    b.HasOne("MyCaseApi.Entities.DocSub3Folder", "DocSub3Folder")
                        .WithMany("DocumentCategory")
                        .HasForeignKey("DocSub3FolderId");

                    b.HasOne("MyCaseApi.Entities.DocumentFolder", "DocumentFolder")
                        .WithMany()
                        .HasForeignKey("DocuementFolderId");

                    b.Navigation("DocSub1Folder");

                    b.Navigation("DocSub2Folder");

                    b.Navigation("DocSub3Folder");
