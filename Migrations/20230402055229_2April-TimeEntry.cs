...
{
    public partial class _2AprilTimeEntry : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CFieldValue", x => x.FieldValueID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceDNS = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomField", x => x.FieldId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomPractice", x => x.PracticeFieldID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DirectoryLevel = table.Column<int>(type: "int", nullable: true),
                    Tokken = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HireReason", x => x.ReasonId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyId = table.Column<int>(type: "int", nullable: true),
                    FirmId = table.Column<int>(type: "int", nullable: true),
                    LStatusId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimeEntryActivity", x => x.ActivityId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FilePathbyte = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    VideoFilePathbyte = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    ...
                    DocFilePathbyte = table.Column<byte[]>(type: "varbinary(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocSub1Folder", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DocSub1Folder_DocumentFolders_DocFolderId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DocSub1FolderId = table.Column<int>(type: "int", nullable: false),
                    FirmId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocSub2Folder", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DocSub2Folder_DocSub1Folder_DocSub1FolderId",
                        column: x => x.DocSub1FolderId,
                        principalTable: "DocSub1Folder",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DocSub2FolderId = table.Column<int>(type: "int", nullable: false),
                    FirmId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocSub3Folder", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DocSub3Folder_DocSub2Folder_DocSub2FolderId",
                        column: x => x.DocSub2FolderId,
                        principalTable: "DocSub2Folder",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DocumentCategoryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DocuementFolderId = table.Column<int>(type: "int", nullable: true),
                    DocSub3FolderId = table.Column<int>(type: "int", nullable: true),
                    DocSub2FolderId = table.Column<int>(type: "int", nullable: true),
                    DocSub1FolderId = table.Column<int>(type: "int", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FirmId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DocumentCategory_DocSub1Folder_DocSub1FolderId",
                        column: x => x.DocSub1FolderId,
                        principalTable: "DocSub1Folder",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DocumentCategory_DocSub2Folder_DocSub2FolderId",
                        column: x => x.DocSub2FolderId,
                        principalTable: "DocSub2Folder",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DocumentCategory_DocSub3Folder_DocSub3FolderId",
                        column: x => x.DocSub3FolderId,
                        principalTable: "DocSub3Folder",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DocumentCategory_DocumentFolders_DocuementFolderId",
                        column: x => x.DocuementFolderId,
                        principalTable: "DocumentFolders",
                        principalColumn: "DocumentFolderId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocSub1Folder_DocFolderId",
                table: "DocSub1Folder",
                column: "DocFolderId");

            migrationBuilder.CreateIndex(
                name: "IX_DocSub2Folder_DocSub1FolderId",
                table: "DocSub2Folder",
                column: "DocSub1FolderId");

            migrationBuilder.CreateIndex(
                name: "IX_DocSub3Folder_DocSub2FolderId",
                table: "DocSub3Folder",
                column: "DocSub2FolderId");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentCategory_DocSub1FolderId",
                table: "DocumentCategory",
                column: "DocSub1FolderId");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentCategory_DocSub2FolderId",
                table: "DocumentCategory",
                column: "DocSub2FolderId");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentCategory_DocSub3FolderId",
                table: "DocumentCategory",
                column: "DocSub3FolderId");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentCategory_DocuementFolderId",
                table: "DocumentCategory",
                column: "DocuementFolderId");
        }
